...
// class CustomDoubleTextButtonWidget extends StatelessWidget {
//   final Function? onPressed;
//   final String buttonText;
//   final bool transparent;
//   final EdgeInsets? margin;
...
//
//   const CustomDoubleTextButtonWidget({
//     Key? key,
//     this.onPressed,
...
//       minimumSize: Size(width != null ? width! : 200,
...
//               borderRadius: BorderRadius.circular(radius),
//               border: Border.all(color: Theme.of(context).primaryColor), // Add a red border
//             ),
//             child: TextButton(
//               onPressed: isLoading ? null : onPressed as void Function()?,
//               style: flatButtonStyle,
