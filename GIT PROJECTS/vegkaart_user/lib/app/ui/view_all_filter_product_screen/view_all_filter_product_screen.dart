...
import 'package:vegkaart_customer/app/controller/view_all_filter_product_controller.dart';
...
class ViewAllFilterProductScreen extends StatelessWidget {
  const ViewAllFilterProductScreen({super.key});
        ...
        builder: (controller) {
          return Scaffold(
              ...
              appBar: CommonUI.customAppBar(
                context,
                title: Text(controller.title.toString().replaceAll('[', '').replaceAll(']', '').tr,
                            ...
                            child: Row(
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: InkWell(
                                    onTap: () {
                                      Get.delete<FilterProductController>();
                                      Get.to(const SearchScreen(), transition: Transition.rightToLeftWithFade)!.then((value) {
                                        //  controller.getData();
                                      });
                                    },
                          ...
                          controller.filterProductList.isEmpty
                              ? Expanded(
                                  child: Constant.emptyView(
                                      ...
                                      text: "Not Found".tr,
                                      description: "We apologize, but we could not find the keyword you were looking for. Please try another search term.".tr))
                              : Expanded(
                                  child: SizedBox(
                                      ...
                                      itemBuilder: (context, index) {
                                        return InkWell(
                                          ...
                                          child: AllProductListWidget(
                                            trustedBrandItem: controller.filterProductList[index],
                                          ),
                                        );
                                      },
