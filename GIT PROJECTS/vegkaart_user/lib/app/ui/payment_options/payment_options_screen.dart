...
import 'package:vegkaart_customer/app/controller/payment_options_controller.dart';
        ...
        builder: (controller) {
          return Scaffold(
            ...
            appBar: CommonUI.customAppBar(
              context,
              title: Text("Bill  : ${Constant.amountShow(amount: controller.totalAmount.value.toString())}".tr,
                    ...
                    Expanded(
                      child: InkWell(
                        onTap: () async {
                          ...
                          if (controller.selectedPaymentMethod.value == controller.paymentModel.value.paypal!.name) {
                            ...
                            controller.mercadoPagoMakePayment(
                                context: context,
                                amount: double.parse(controller.totalAmount.value).toStringAsFixed(Constant.currencyModel!.decimal)
                            );
