...
import 'package:vegkaart_customer/app/model/item_attributes.dart';
...
class HorizontalProductListComponent extends StatefulWidget {
  final ProductModel trustedBrandItem;
  const HorizontalProductListComponent({super.key, required this.trustedBrandItem,});

  @override
  State<HorizontalProductListComponent> createState() => _HorizontalProductListComponentState();
}

class _HorizontalProductListComponentState extends State<HorizontalProductListComponent> {
                                    ...
                                    Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          //               shrinkWrap: true,
                                          //               padding: EdgeInsets.zero,
                                          //               itemCount: trustedBrandItem.value.itemAttributes!.attributes![index].attributeOptions!.length > 2
                                          //                   ? 2
                                          //                   : trustedBrandItem.value.itemAttributes!.attributes![index].attributeOptions!.length,
                                          //
