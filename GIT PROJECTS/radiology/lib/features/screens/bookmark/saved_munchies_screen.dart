...
class SavedMunchiesScreen extends StatelessWidget {
  SavedMunchiesScreen({super.key});
  ...
  Widget build(BuildContext context) {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Get.find<BookmarkController>().getSavedMunchiesPaginatedList('1');
    });
    ...
    scrollController.addListener(() {
      if (scrollController.position.pixels ==
          ...
          Get.find<BookmarkController>().savedMunchiesList != null &&
          !Get.find<BookmarkController>().isSavedMunchiesLoading) {
        if (Get.find<BookmarkController>().offset < 10) {
          ...
          Get.find<BookmarkController>().getSavedMunchiesPaginatedList(
    ...
    return GetBuilder<BookmarkController>(builder: (spottersControl) {
      final spottersList = spottersControl.savedMunchiesList;
        ...
        Scaffold(
          ...
          body:  Stack(
            children: [
                  ...
                  return GetBuilder<BookmarkController>(
                      builder: (bookmarkControl) {
                        ...
                        return NotesViewComponent(
                          ...
                          saveNote: () {
                            // isBookmarked ?
                            bookmarkControl.removeMunchieBookMarkList(int.parse(spottersList[i].id.toString()));
              ...
              if (spottersControl.isSavedMunchiesLoading)
                const Center(child: LoaderWidget()),
            ],
          ),
