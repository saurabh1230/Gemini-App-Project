...
class NotesSubCategoryScreen extends StatelessWidget {
  ...
  NotesSubCategoryScreen({super.key, required this.noteListModel,/* required this.childName, required this.childColorString*/});
                  ...
                  children: [
                    ...
                    noteListModel!.child != null && noteListModel!.child!.isNotEmpty
                      ...
                      separatorBuilder: (BuildContext context, int index) => sizedBoxDefault(),
                        ...
                        : const Center(child: EmptyDataWidget(image: Images.emptyDataImage, text: "No Notes Available")),
                  ],
                ),
              ),
            ),
