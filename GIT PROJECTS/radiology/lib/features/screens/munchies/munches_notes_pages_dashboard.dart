...
class MunchesNotesDashboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      Get.find<MunchiesController>().getMunchesPaginatedList("1", categoryId!);
      Get.find<MunchiesController>().currentPageIndex.value = lastPageIndex; // Set initial page index
      _loopPageController.jumpToPage(lastPageIndex); // Restore last page index
    });

    Get.find<MunchiesController>().setOffset(1);

    WidgetsBinding.instance.addPostFrameCallback((_) {
      _loopPageController.addListener(() async {
        final MunchiesController controller = Get.find<MunchiesController>();
        ...
        if (controller.categoryNoteList != null && pageIndex < controller.categoryNoteList!.length) {
          final noteValue = Get.find<MunchiesController>().currentPageIndex.value + 1;
          controller.readMunchesNoteStatusApi('${noteValue}', categoryId.toString());
        }
        ...
        child: Scaffold(
          ...
          Container(
            ...
            child: Padding(
              ...
              child: Obx(() {
                final pageIndex = Get.find<MunchiesController>().currentPageIndex.value;
            ...
            children: [
              Column(
                children: [
                  ...
                  isListEmpty && !noteControl.isMunchiesNotesLoading
                      ...
                      itemBuilder: (context, i) {
                        return GetBuilder<BookmarkController>(
                            builder: (bookmarkControl) {
                              bool isBookmarked = bookmarkControl.bookmarkMunchieIdList
              ...
              if (noteControl.isMunchiesNotesLoading)
