        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          title != null ? Padding(
            ...
            child: Text(
              ...
              style: poppinsMedium.copyWith(fontSize: Dimensions.fontSize20, color: Colors.red),
            ),
          ) : const SizedBox(),

          Padding(
            padding: const EdgeInsets.all(Dimensions.paddingSize20),
            child: Text(description, style: poppinsMedium.copyWith(fontSize: Dimensions.fontSize15), textAlign: TextAlign.center),
          ),

          adminText != null && adminText!.isNotEmpty ? Padding(
            padding: const EdgeInsets.all(Dimensions.paddingSize20),
            child: Text('[$adminText]', style: poppinsMedium.copyWith(fontSize: Dimensions.fontSize15), textAlign: TextAlign.center),
          ) : const SizedBox(),
          ...
          /* GetBuilder<DeliveryManController>(builder: (dmController) {
            ...
            Expanded(child: TextButton(
              ...
              child: Text(
                ...
                style: poppinsBold.copyWith(color: Theme.of(context).cardColor),
              ),
            )),
