...
Widget sizedBox150() {
  return const SizedBox(height: Dimensions.paddingSize150);
}
...
Widget sizedBox30() {
  return const SizedBox(height: Dimensions.paddingSize30);
}
Widget sizedBox20() {
  return const SizedBox(height: Dimensions.paddingSize20);
}
Widget sizedBoxDefault() {
...
Widget sizedBox5() {
  return const SizedBox(height: Dimensions.paddingSize5);
}
Widget sizedBox8() {
