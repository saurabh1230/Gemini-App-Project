                ...
                children: [
                  ...
                  CustomTextField(
                    ...
                    onTap: () async {
                      DateTime? pickedDate = await showDatePicker(
                        context: context,
                        initialDate: profileControl.selectedDate ?? DateTime.now(),
                    ...
                    validation: (value) {
                      if (value == null || value.isEmpty) {
                        ...
                        DateTime selectedDate = profileControl.selectedDate ?? DateTime.now();
                  ...
                  CustomDropdownField(
                    ...
                    onChanged: (String? newValue) {
                      if (newValue != null) {
                        profileControl.updateGender(newValue); // Update controller
                      }
                    },
                  ...
                  CustomDropdownField(
                    ...
                    selectedValue: profileControl.selectedDiabetes.isEmpty
                        ? null
                  ...
                  CustomDropdownField(
                    ...
                    selectedValue: profileControl.selectedGlasses.isEmpty
                        ? null
                  ...
                  CustomButtonWidget(
                    ...
                    onPressed: () {
                      if(_formKey.currentState!.validate()) {
                        ...
                        print('diabaties name == ${profileControl.getDiabetesStatus()}');
                        print('selectedGlasses name == ${profileControl.getGlassesStatus()}');
                        print('selectedHealth name == ${profileControl.getBpStatus()}');
                        print('selectedGender name == ${profileControl.getGenderStatus()}');
