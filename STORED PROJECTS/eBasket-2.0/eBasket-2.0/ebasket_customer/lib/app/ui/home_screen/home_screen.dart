                  ...
                  appBar: AppBar(
                    ...
                    flexibleSpace: Container(
                      ...
                      decoration: BoxDecoration(
                          image: DecorationImage(image: AssetImage('assets/icons/ic_home_app_bg.png',),fit: BoxFit.cover,
                          )
                      ),
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            ...
                            child: InkWell(
                              ...
                              child: Row(
                                children: [
                                  Icon(Icons.location_on_sharp,color: Colors.yellow,),
                                  Flexible(
                                    child: Column(
                         ...
                         /*     Row(
                              ...
                              Container(
                                ...
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    print('check title ${todaySpecial.title}');
                                    return InkWell(
                                      onTap: () {},
                              ...
                              SizedBox(height: 120,
                                child: ListView.separated(
                                  ...
                                  itemCount: controller.categoryList.length,
                                  itemBuilder: (_,i) {
                                    CategoryModel categoryItem = controller.categoryList[i];
                                    return CategoryItemWidget(
                                      categoryItem: categoryItem,
                                      colorCode: categoryItem.color.toString(),
                                    );
                              ...
                              HorizontalProductWidget(
                                ...
                                items: productControl.freshVegetablesList, // Pass the actual list of items here
                                onItemTap: (item) {
                                  // Handle item tap
                                },
                              ),
                              ...
                              HorizontalProductWidget(
                                title: 'Fresh Fruits',
                                items: productControl.freshFruitsList, // Pass the actual list of items here
                                onItemTap: (item) {
                                  // Handle item tap
                                },
                              ),
                              ...
                              HorizontalProductWidget(
                                ...
                                items: productControl.ExoticVegetablesList, // Pass the actual list of items here
                                onItemTap: (item) {
                                  // Handle item tap
                                },
                              ),
                              ...
                              HorizontalProductWidget(
                                title: 'Exotic Fruits',
                                items: productControl.ExoticFruitsList, // Pass the actual list of items here
                                onItemTap: (item) {
                                  // Handle item tap
                                },
                              ),
                              ...
                              HorizontalProductWidget(
                                ...
                                items: productControl.GreenVegetablesList, // Pass the actual list of items here
                                onItemTap: (item) {
                                  // Handle item tap
                                },
                              ),
                              ...
                              HorizontalProductWidget(
                                title: 'Beverages',
                                items: productControl.baveragesList, // Pass the actual list of items here
                                onItemTap: (item) {
                                  // Handle item tap
                                },
                              ),
                              ...
                              // HorizontalProductWidget(
                              //   title: 'Bakery',
                              //   items: productControl.bakeryList, // Pass the actual list of items here
                              //   onItemTap: (item) {
                              //     // Handle item tap
                              //   },
                              // ),
...
class CategoryItemWidget extends StatelessWidget {
  ...
  const CategoryItemWidget({super.key, required this.categoryItem, required this.colorCode});
