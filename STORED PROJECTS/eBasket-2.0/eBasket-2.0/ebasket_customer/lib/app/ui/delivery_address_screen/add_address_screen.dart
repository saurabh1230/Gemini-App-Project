                          ...
                          children: [
                            InkWell(
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  children: [
                                    Icon(Icons.location_searching_sharp, color: AppThemeData.groceryAppDarkBlue),
                                    SizedBox(
                                      width: 10,
                                    ),
                                    Text(
                                      "Choose location *".tr,
                                      style: TextStyle(color: AppThemeData.groceryAppDarkBlue, fontFamily: AppThemeData.medium, fontSize: 14),
                                    ),
                                  ],
                                ),
                              ),
